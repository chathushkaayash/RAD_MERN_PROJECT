...
const handleLogout=async()=>{
  ...
  return (
    ...
    {user &&<h3 className="text-white text-sm hover:text-gray-500 cursor-pointer"><Link to="/announcements">Announcements</Link></h3>}
    <h3 className="text-white text-sm hover:text-gray-500 cursor-pointer"><Link to="/forum">Forum</Link></h3>

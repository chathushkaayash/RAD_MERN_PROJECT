const ProfilePosts = () => {
    return (
       ...
       <div className="w-[35%] h-[200px] flex justify-center items-center">
        ...
        <p className="text-xs md:text-lg">the whimsical town of Sipsvillen over his head with a flourish, causing a hilarious shower. Sipsville's folks laughed and learned: hydrating could be a splashy affair. </p>
        </div>
